...
"fr": [("The American Soul", None,
       ...
       ("Literature of Confinement", "Université Tufts, département d’anglais &middot; avec Hilary Binda",
        "J’ai eu l’occasion de participer à ce cours, dispensé par Hilary Binda."),
       ("Prison Justice &amp; Education", "Tufts Prison Initiative &middot; coécrit avec Hilary Binda",
...
"es": [("The American Soul", None,
       ...
       ("Literature of Confinement", "Universidad Tufts, Departamento de Inglés &middot; con Hilary Binda",
        "Tuve la oportunidad de colaborar en este curso, impartido por Hilary Binda."),
       ("Prison Justice &amp; Education", "Tufts Prison Initiative &middot; coescrito con Hilary Binda",
...
"pt": [("The American Soul", None,
       ...
       ("Literature of Confinement", "Universidade Tufts, Departamento de Inglês &middot; com Hilary Binda",
        "Tive a oportunidade de colaborar neste curso, ministrado por Hilary Binda."),
       ("Prison Justice &amp; Education", "Tufts Prison Initiative &middot; coescrito com Hilary Binda",
